        ...
        <>
            ...
            <td className="flex right-options">
                ...
                <div
                    ...
                    <svg role="img" height="32" width="32" aria-hidden="true" viewBox="0 0 24 24" data-encore-id="icon" className="Svg-sc-ytk21e-0 ldgdZj display-none"><path d="M4.5 13.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3zm15 0a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3zm-7.5 0a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3z"></path></svg>
                </div>
                <button onClick={location.pathname === "/search" ? showStationsDropdownModal : () => onAddToStation(station._id)} className="add-btn">
                    Add
                </button>
                {/* <button onClick={() => onAddToStation(station._id)} className="add-btn">
                    Add
                </button> */}
