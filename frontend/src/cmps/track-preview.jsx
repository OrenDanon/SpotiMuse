export function TrackPreview({ track, idx }) {
    const date=new Date(track.addedAt).getDate()
    console.log(date);
    return (
        <tr className="track-preview grid-colums">
            <td className="flex">{idx + 1}
            </td>
            <td className="track-title flex">
            ...
            <td className="flex right-section">
                ...
                <svg role="img" height="16" width="16" aria-hidden="true" viewBox="0 0 16 16" data-encore-id="icon" class="Svg-sc-ytk21e-0 ldgdZj"><path d="M3 8a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zm6.5 0a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zM16 8a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0z"></path></svg>
                </div>
            </td>
        </tr>
    )
