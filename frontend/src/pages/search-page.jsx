        ...
        <div>
            ...
            <div className="search-page">
                <form onSubmit={(ev) => ev.preventDefault()} action="">
                    <svg role="img" height="17" width="17" aria-hidden="true" class="Svg-sc-ytk21e-0 uPxdw mOLTJ2mxkzHJj6Y9_na_ icon" viewBox="0 0 24 24"><path d="M10.533 1.279c-5.18 0-9.407 4.14-9.407 9.279s4.226 9.279 9.407 9.279c2.234 0 4.29-.77 5.907-2.058l4.353 4.353a1 1 0 101.414-1.414l-4.344-4.344a9.157 9.157 0 002.077-5.816c0-5.14-4.226-9.28-9.407-9.28zm-7.407 9.279c0-4.006 3.302-7.28 7.407-7.28s7.407 3.274 7.407 7.28-3.302 7.279-7.407 7.279-7.407-3.273-7.407-7.28z"></path></svg>
                    <input onChange={handleChange} value={term} type="search" name="" id="" placeholder='What do you want to listen to?' >
                    </input>
                </form>
                {data.songs ?
                    <section  >
